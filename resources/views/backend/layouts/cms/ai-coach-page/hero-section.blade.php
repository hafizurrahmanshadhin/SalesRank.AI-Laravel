...
@section('title', 'AI Coach | Hero Section')
        ...
        <div class="container-fluid">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="{{ route('cms.ai-coach-page.hero-section.index') }}">CMS</a>
                                </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('cms.ai-coach-page.hero-section.update') }}"
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                            placeholder="About System...">{{ old('description', $data->description ?? '') }}</textarea>
                                        @error('description')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div>
                                            ...
                                            <input type="text"
                                                ...
                                                name="sub_title" id="sub_title" placeholder="Please Enter Sub Title"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control @error('sub_description') is-invalid @enderror" id="sub_description"
                                            name="sub_description" placeholder="About System...">{{ old('sub_description', $data->sub_description ?? '') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div>
                                            ...
                                            <input class="form-control dropify @error('banner') is-invalid @enderror"
                                                ...
                                                data-default-file="@isset($data){{ asset($data->banner) }}@endisset">
                                            @error('banner')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
