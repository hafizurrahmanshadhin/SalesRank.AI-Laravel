...
@section('title', 'Collaboration FAQ Create')
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('collaboration.index') }}">Collaboration FAQ</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('collaboration.store') }}" method="POST" id="faq_form">
                                @csrf
